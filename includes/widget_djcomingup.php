...
class DJ_Upcoming_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_args = array('classname' => 'DJ_Upcoming_Widget', 'description' => __('The upcoming DJs/Shows.', 'radio-station'));
		parent::__construct(
				'DJ_Upcoming_Widget', // Base ID
				__('Radio Station: Upcoming DJ On-Air', 'radio-station'), // Name
				$widget_args // Args
		);
	}
