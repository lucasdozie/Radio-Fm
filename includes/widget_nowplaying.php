...
class Playlist_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_args = array('classname' => 'Playlist_Widget', 'description' => __('Display the current song.', 'radio-station'));
		parent::__construct(
				'Playlist_Widget', // Base ID
				__('Radio Station: Now Playing', 'radio-station'), // Name
				$widget_args // Args
		);
	}
